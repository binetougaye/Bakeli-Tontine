    ...
    <div>
      <table className="tabla1">
        <thead className=" shadow ">
          <tr>
            <th className=" th1 p-3" scope="col">
              {th1}
            </th>
            <th className="p-2 th1" scope="col">
              {th2}
            </th>
            <th className="p-2 th1" scope="col">
              {th3}
            </th>
            <th scope="col" className="px-4 th1">
              {th4}
            </th>
            <th className="p-2 th1" scope="col">
              {th5}
          ...
          {tableau.map((item, index) => (
            <tr key={index}>
              ...
              <td className="d-flex gap-3 td1">
                ...
                >
                  <div
                    ...
                    style={{ width: item.progress1 }}
                  ></div>
                  <div
                    className="progress-bar2"
                    style={{ width: item.progress2 }}
                  ></div>
                  <div
                    className="progress-bar"
                    style={{ width: item.progress1 }}
                  ...
                  <div
                    className="progress-bar2"
                    style={{ width: item.progress3 }}
                  ></div>
                  <div
                    className="progress-bar2"
                    style={{ width: item.progress4 }}
                  ></div>
                  <div
                    className="progress-bar2"
                    style={{ width: item.progress5 }}
                  ></div>
                </div>
                <div className="pro">
              ...
              <td>
                ...
                <div className="statut9 text-danger fw-bold">
                  {item.statut2}
                </div>
