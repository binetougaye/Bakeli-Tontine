    ...
    <div className='container'>
      ...
      <div>
        <div className='input d-flex justifi' >
          <div class="mb-3">
            <label for="" class="form-label ps-3  mt-3">Prenom</label>
            <input type="text" className="form-control m-2 nom" />
          </div>
          <div className="mb-3">
            <label for="" class="form-label ps-3  mt-3">Nom</label>
            <input type="text" className="form-control m-2 nom" />
          </div>
        </div>
        ...
        <div className='d-flex flex-column '>
          <div cclassName="mb-3">
            <label for="" class="form-label ps-3 mt-3">Email </label>
            <input type="email" className=' form-control m-2' />
          </div>
          <div cclassName="mb-3">
            <label for="" class="form-label ps-3 mt-3">Telephone</label>
            <input type="telephone" className='form-control m-2' />
          </div>
          <div className="mb-3">
            <label for="" class="form-label ps-3 mt-3">Status</label>
