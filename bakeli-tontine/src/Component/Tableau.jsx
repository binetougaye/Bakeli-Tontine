  ...
  return (
    ...
    <div style={{ position: "relative", left: "25px", fontSize: "13px" }}>
      ...
      <Modal show={showModal} onHide={closeModal} className="modalcontainer">
        <Modal.Header
          closeButton
          style={{ background: "#20DF7F", fontSize: "7px", height: "40px" }}
        >
          <Modal.Title
            style={{ fontSize: "15px", position: "relative", left: "20px" }}
          >
            Détails Cotisations
          </Modal.Title>
        </Modal.Header>
        <h5 style={{ position: "relative", left: "36px" }}>
          Selena Roy
          <br></br>
          <span
        ...
        <Modal.Body>
          {selectedMember && (
            <div>
              ...
              >
                <strong>Total:300.000 FCFA</strong>
              </p>
            </div>
          )}
        </Modal.Body>
